"""
Fetch Deribit futures OHLCV and print head.

Usage:
    poetry run python scripts/fetch_deribit_futures_ohlcv.py --symbol BTC-PERPETUAL --limit 25
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Fetch Deribit futures OHLCV and print head")
    p.add_argument(
        "--symbol",
        default="BTC-PERPETUAL",
        help="Futures symbol, e.g., BTC-PERPETUAL or BTC-29MAR24 (default: BTC-PERPETUAL)",
    )
...
def main() -> None:
    ...
    endpoint = f"{base_url}/data/ohlc/deribit/futures/"
