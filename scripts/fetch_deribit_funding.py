"""
Fetch Deribit funding data and print head.

Usage:
    poetry run python scripts/fetch_deribit_funding.py --symbol BTC-PERPETUAL --limit 25
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Fetch Deribit funding data and print head")
    p.add_argument(
        "--symbol",
        default="BTC-PERPETUAL",
        help="Funding symbol, e.g., BTC-PERPETUAL (default: BTC-PERPETUAL)",
    )
...
def main() -> None:
    ...
    # Note: Docs list endpoint as /data/ohlc/deribit/futures/funding
    endpoint = f"{base_url}/data/ohlc/deribit/futures/funding"
