"""
Fetch Deribit DVOL OHLC data from CryptoDataDownload and print head.

Usage:
    poetry run python scripts/fetch_deribit_volatility.py --symbol BTC --limit 25
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Fetch DVOL OHLC data and print head")
    p.add_argument("--symbol", default="BTC", help="Volatility ticker, e.g., BTC or ETH (default: BTC)")
...
def main() -> None:
    ...
    endpoint = f"{base_url}/data/ohlc/deribit/volatility"
